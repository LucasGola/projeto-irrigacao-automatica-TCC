...
module.exports = function (sequelize, DataTypes) {
  var Plants = /*#__PURE__*/function (_Model) {
    function Plants() {
      _classCallCheck(this, Plants);
      return _callSuper(this, Plants, arguments);
    }
    _inherits(Plants, _Model);
    return _createClass(Plants, null, [{
      key: "associate",
      value:
      /**
  ...
  Plants.init({
    ...
    irrigationFrequency: DataTypes.FLOAT
  }, {
    sequelize: sequelize,
    modelName: 'Plants',
    paranoid: true
