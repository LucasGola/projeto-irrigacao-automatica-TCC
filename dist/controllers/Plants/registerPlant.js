...
var registerPlant = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
            ...
            var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(transaction) {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return _models["default"].Plants.create({
                      userId: userId,
                      name: name,
                      type: type,
                  ...
                  case 2:
                    ...
                    throw new Error("Não foi possível cadastrar a planta.");
                  case 5:
                    _context.next = 7;
                    return (0, _createLogs.createActionLog)("Planta criada.", null, null, data.id);
                  case 7:
        ...
        case 8:
          ...
          _context2.next = 12;
          return (0, _createLogs.createErrorLog)(_context2.t0.stack, "Criação de planta", null);
        case 12:
  ...
  return function registerPlant(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var _default = exports["default"] = registerPlant;