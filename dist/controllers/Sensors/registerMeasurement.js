...
var _getPlantInfo = _interopRequireDefault(require("../Plants/getPlantInfo"));
...
var registerMeasurement = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body, dht11Humidity, dht11Temperature, hygrometer, waterFlow, batteryPercent, plant;
            ...
            var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(transaction) {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  ...
                  case 2:
                    dht11HumidityData = _context.sent;
                    _context.next = 5;
                    return _models["default"].SensorLogs.create({
                      sensor: "DHT11 - Temperatura",
                      measurement: dht11Temperature,
                      // Graus Celcius
                      plantId: plant.id
                    }, {
                      transaction: transaction
                  ...
                  case 5:
                    dht11TemperatureData = _context.sent;
                    _context.next = 8;
                    return _models["default"].SensorLogs.create({
                      sensor: "Higrômetro",
                  ...
                  case 14:
                    batteryPercentData = _context.sent;
                    if (!(_lodash["default"].isNil(dht11HumidityData) || _lodash["default"].isNil(dht11TemperatureData) || _lodash["default"].isNil(hygrometerData) || _lodash["default"].isNil(waterFlowData) || _lodash["default"].isNil(batteryPercentData))) {
                      _context.next = 17;
                      break;
                    }
                  ...
                  case 17:
                    _context.next = 19;
                    return (0, _createLogs.createActionLog)("Dados dos sensores registrados.", null, null, plant.id);
                  case 19:
                    return _context.abrupt("return", res.status(200).json({
                      message: "Dados dos sensores registrados com sucesso!",
                      data: {
                        dht11HumidityData: dht11HumidityData,
                        dht11TemperatureData: dht11TemperatureData,
                        hygrometerData: hygrometerData,
...
var _default = exports["default"] = registerMeasurement;